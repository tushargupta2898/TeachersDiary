...
public class Constants {
     ...
     *
     */
    public static final String LOGINURL = "http://192.168.43.65/attendance/login.php";
    public static final String INSERTATTEND = "http://192.168.43.65/attendance/insertAttendance.php";
    public static final String VIEWATTENDANCE = "http://192.168.43.65/attendance/viewAttendance.php";
    public static final String QUICKATTENDANCE = "http://192.168.43.65/attendance/quickAttendance.php";
