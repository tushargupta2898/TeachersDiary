...
import com.attendance.ui.activities.CalenderActivity;
import com.attendance.ui.activities.FacultyActivity;
import com.attendance.ui.activities.MainActivity;
import com.attendance.ui.activities.ResourceActivity;
import com.attendance.ui.activities.SubjectActivity;
import com.attendance.ui.activities.WeekActivity;
            ...
            public void run() {
                switch (item.getItemId()) {
                    ...
                    case R.id.about:
                        ...
                        break;
                    case R.id.timetable:
                        Intent intents1 = new Intent(getActivity(), WeekActivity.class);
                        startActivity(intents1);
                        break;
                    case R.id.sylabus:
                        Intent intents2 = new Intent(getActivity(), SubjectActivity.class);
                        startActivity(intents2);
                        break;
                    case R.id.faculty:
                        Intent intents3 = new Intent(getActivity(), FacultyActivity.class);
                        startActivity(intents3);
                        break;
                    case R.id.calendar:
                        Intent intents4 = new Intent(getActivity(), CalenderActivity.class);
                        startActivity(intents4);
                        break;
                    case R.id.resources:
                        Intent intents5 = new Intent(getActivity(), ResourceActivity.class);
